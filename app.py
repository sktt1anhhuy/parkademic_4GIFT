...
DEMO_IMAGE = 'demo.jpg'
DEMO_VIDEO = 'demo.mp4'
# model_path = 'best_mortobike.pt'
model_path = 'best_car_inUsed.pt'
class_name_dict = {0: 'car plate'}
...
st.title('Car Licence Plate Detector')
...
if app_mode == 'About App':
    st.markdown('Ever circled a parking lot endlessly, searching for a free space? With **Parkademic**, \
                 those days are over! Our innovative app uses cutting-edge Automatic Number Plate \
                 Recognition (ANPR) technology to streamline your parking experience.')
    ...
    # About Us \n
      ...
      If you you want to buy our website, do not hesitate to contact us at \n
        ...
        Email: parkademic.4gift@gmail.com
    ''')
